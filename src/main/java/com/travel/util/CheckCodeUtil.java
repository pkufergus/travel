...
public class CheckCodeUtil {
	...
	public  String checkCode() throws ServletException, IOException {
		// String createTypeFlag =
		// request.getParameter("createTypeFlag");//接收客户端传递的createTypeFlag标识
		// 1.在内存中创建一张图片
		...
		// String random = drawRandomNum((Graphics2D)
		// g,createTypeFlag);//根据客户端传递的createTypeFlag标识生成验证码图片
		// 7.将随机数存在session中
...
System.out.println(random+"===");
	...
	public static String  isChineseChar(String str){
	...
	public static void main(String[] args) {
		System.out.println(isChineseChar("new york"));
		}
}